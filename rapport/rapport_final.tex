...
% ===================== NOMS FRANÇAIS (babel-french indisponible) =====================
...
\vspace{0.3cm}
{\normalsize Rapport de stage de 2e année\par}
...
\vspace{0.4cm}
{\color{bleuSecondaire}\large Conception et implémentation d'un tuteur IA fondé sur un système RAG\par}
...
Enfin, mes remerciements vont à ma famille pour son soutien indéfectible.
