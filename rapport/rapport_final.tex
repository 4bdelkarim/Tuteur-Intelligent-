...
\midrule
Tramway        & 10\,km (A/R) & 90 jours  & 3,8  & 3,42 \\
Marche à pied  & 10\,km (A/R) & 10 jours  & 0    & 0    \\
\midrule
\textbf{Total} &             &           &      & \textbf{3,42} \\
\bottomrule
\end{tabularx}
...
Le bilan carbone total des déplacements s'élève à environ \textbf{3,4\,kg CO\textsubscript{2}eq} sur l'ensemble de la période de stage, soit l'équivalent d'environ 15\,km en voiture thermique. Ce résultat, très modeste, reflète le choix d'une mobilité douce (transports en commun et marche à pied), cohérent avec la politique de développement durable de l'UCA et du LIMOS.
...
\begin{itemize}
  \item Déplacements domicile--LIMOS~: 3,42\,kg CO\textsubscript{2}eq.
\end{itemize}
Soit un total d'environ \textbf{3,4\,kg CO\textsubscript{2}eq} pour l'ensemble du stage, un impact carbone négligeable, représentant moins de 0,04\,\% de l'empreinte carbone annuelle moyenne d'un Français (environ 9\,t CO\textsubscript{2}eq/an).
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/gantt_previsionnel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/gantt_realise.png}
...
Corpus            & Base de données multimodale (non disponible) & Cours de Machine Learning (D2L, pages web) & Corpus plus accessible et maîtrisé \\
...
Le projet a été livré dans les délais impartis (août 2026). La réorientation du sujet, bien que constituant un écart majeur par rapport au descriptif initial, a abouti à un livrable plus riche et plus complet, en parfaite adéquation avec les besoins exprimés par le laboratoire.
