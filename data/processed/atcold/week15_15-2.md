...
**Figure 8**Free energy $$F_{\beta}(\vect{y}) \dot{=} -\frac{1}{\beta}\log\frac{1}{\vert\mathcal{Z}\vert}\int_\mathcal{Z}\exp[-{\beta}E(\vect{y},z)]\mathrm{d}z$$
...
**Figure 10**Untrained model manifold $$z = [0:\frac{\pi}{24}: 2\pi[\quad\text{(exclusive of }2\pi)$$
...
**Figure 11**Untrained model manifold
