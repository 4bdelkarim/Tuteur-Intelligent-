...
- 
Deterministic functions - Takes in multiple inputs and can produce multiple outputs
...
- 
Scalar-valued function - Used to represent cost functions
...
$$\frac{\mathrm{d}C}{\mathrm{d}z} = \frac{\mathrm{d}C}{\mathrm{d}s[0]}\cdot w[0]+\frac{\mathrm{d}C}{\mathrm{d}s[1]}\cdot w[1]+\frac{\mathrm{d}C}{\mathrm{d}s[2]}\cdot w[2]$$PyTorch implementation of neural network and a generalized backprop algorithm
