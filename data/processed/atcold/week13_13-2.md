...
**Figure 1:**Demonstrates 1-hop and 2-hop neighbourhoods
...
**Figure 3:**Isotropic model $$h_{i}^{l+1} = f_\text{GCN}(h_{i}^{l}, \{h_{j}^l: j \rightarrow i\})$$
...
$$h_{i}^{l+1} = (1 + \epsilon)h_{i}^{l} + \sum_{j \in N_{i}} h_{j}^{l}$$ **Figure 5:**Examples of two isomorphic graphs
...
**Figure 12:**Graph Classification task 
...
**Figure 14:**Edge Classification task. 
