...
$$F (x, y) = \min_{z} \; E(x, y, z)$$The forward algorithm
...
where the $ \lambda $ terms denote Lagrange multipliers (see Paul’s online notes for a refresher if Calc 3 was a while ago).
...
**Figure 6:**Jensen's Inequality (taken from Wikipedia)
