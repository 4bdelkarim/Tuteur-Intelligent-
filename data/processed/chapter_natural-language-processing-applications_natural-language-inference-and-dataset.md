---
source_url: https://d2l.ai/chapter_natural-language-processing-applications/natural-language-inference-and-dataset.html
title: 16.4. Natural Language Inference and the Dataset
chapter: '16'
section_number: '16.4'
date: null
extractor: d2l
source_type: web
source: chapter_natural-language-processing-applications_natural-language-inference-and-dataset
---

# 16.4. Natural Language Inference and the Dataset

In Section 16.1, we discussed the problem of sentiment
