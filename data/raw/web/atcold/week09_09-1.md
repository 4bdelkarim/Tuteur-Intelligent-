---
source_url: "https://atcold.github.io/NYU-DLSP20/en/week09/09-1"
title: "Deep Learning"
date: "2020-03-30"
extractor: "generic"
---
...
![](/NYU-DLSP20/images/week09/09-1/q7pSvUJ.png)**Fig 1:** Discriminative Recurrent Sparse Auto-Encoder Network
...
- $L_1$: Apply $L_1$ criterion on the feature vector $Z$ to make it sparse.
- Reconstruct $X$: This is done using a decoding matrix that reproduces the input on the output. This is done by minimizing square error, indicated by $W_d$ in Figure 1.
- Add a Third Term: This third term, indicated by $W_c$, is a simple linear classifier which attempts to predict a category.
...
![](/NYU-DLSP20/images/week09/09-1/kpDK8Xu.png)**Fig 2:** Auto-Encoder with Group Sparsity
...
![](/NYU-DLSP20/images/week09/09-1/7akkfhv.png)**Fig 3:** Structure of Convolutional RELU with Group Sparsity
...
![](/NYU-DLSP20/images/week09/09-1/EuhORxu.jpg)**Fig 4:** Image Level Training, local filters but no weight sharing
...
![](/NYU-DLSP20/images/week09/09-1/AS3giSt.jpg)**Fig 5:** Invariant Features through Lateral Inhibition
...
![](/NYU-DLSP20/images/week09/09-1/sszdGh0.png)**Fig 6:** Invariant Features through Lateral Inhibition (Tree Form)
