...
- 
**Fig. 1(b)**shows a similar spiral, with an added Gaussian noise term. This is represented mathematically by**Eqn. 1(b)**.In both cases, these points are not linearly separable. ![](/NYU-DLSP20/images/week02/02-3/clean-spiral.png) 
 **Fig. 1(a)**"Clean" 2D spiral![](/NYU-DLSP20/images/week02/02-3/noisy-spiral.png) 
...
![](/NYU-DLSP20/images/week02/02-3/FC-net.png)**Fig. 4**Fully connected neural network
