---
source_url: "https://atcold.github.io/NYU-DLSP20/en/week10/10-2/"
title: "Deep Learning"
date: "2020-04-06"
extractor: "generic"
---
...
![](/NYU-DLSP20/images/week10/10-2/fig01.png)**Fig. 1**: Feature representations at each layer
...
![](/NYU-DLSP20/images/week10/10-2/fig02.png)**Fig. 2**: Performance of Jigsaw based on each layer

### What we want from pre-trained features?

- 
Represent how images relate to one another - ClusterFit: Improving Generalization of Visual Representations
 
- 
Be robust to “nuisance factors” – Invariance *E.g.*exact location of objects, lighting, exact colour- PIRL: Self-supervised learning of Pre-text Invariant Representations
...
![](/NYU-DLSP20/images/week10/10-2/fig03.png)**Fig. 3**: Cluster step
...
![](/NYU-DLSP20/images/week10/10-2/fig04.png)**Fig. 4**: Predict step
...
![](/NYU-DLSP20/images/week10/10-2/fig05.png)**Fig. 5**: "Standard" pretrain + transfer *vs.* "Standard" pretrain + ClusterFit
...
![](/NYU-DLSP20/images/week10/10-2/fig06.png)**Fig. 6**: Control Experiment
...
![](/NYU-DLSP20/images/week10/10-2/fig07.png)**Fig. 7**: Transfer performance on different datasets
...
![](/NYU-DLSP20/images/week10/10-2/fig08.png)**Fig. 8**: Gains without extra data, labels or changes in architecture
...
![](/NYU-DLSP20/images/week10/10-2/fig09.png)**Fig. 9**: Groups of Related and Unrelated Images
...
![](/NYU-DLSP20/images/week10/10-2/fig10.png)**Fig. 10**: Contrastive Learning and Loss Function
...
![](/NYU-DLSP20/images/week10/10-2/fig11.png)**Fig. 11**: Tracking the Objects
...
### Nearby patches *vs.* distant patches of an Image
 ...
 ![](/NYU-DLSP20/images/week10/10-2/fig12.png) **Fig. 12**: Nearby patches *vs.* distant patches of an Image
...
### Patches of an image *vs.* patches of other images
 ...
 ![](/NYU-DLSP20/images/week10/10-2/fig13.png) **Fig. 13**: Patches of an Image *vs.* Patches of Other Images
...
![](/NYU-DLSP20/images/week10/10-2/fig14.png)**Fig. 14**: Pretext Image Transform and Standard Pretext Learning
...
![](/NYU-DLSP20/images/week10/10-2/fig15.png)**Fig. 15**: PIRL
...
![](/NYU-DLSP20/images/week10/10-2/fig16.png)**Fig. 16**: How does the Memory Bank Work
...
**Fig. 17**: Object detection performance on different datasets
...
![](/NYU-DLSP20/images/week10/10-2/fig18.png)**Fig. 18**: Semi-supervised learning on ImageNet
...
![](/NYU-DLSP20/images/week10/10-2/fig19.png)**Fig. 19**: ImageNet classification with linear models
...
**Fig. 20**: Pre-training on uncurated YFCC images
...
**Fig. 21**: Quality of PIRL representations per layer
...
![](/NYU-DLSP20/images/week10/10-2/fig22.png)**Fig. 22**: Effect of varying the number of patch permutations
...
**Fig. 23**: Using PIRL with (combinations of) different pretext tasks
...
- It’s not very clear as to which set of data transforms matter. Although Jigsaw works, it’s not very clear why it works.
- Saturation with model size and data size.
- What invariances matter? (One could think about what invariances work for a particular supervised task in general as future work.)
...
- In PIRL, why is NCE (Noise Contrastive Estimator) used for minimizing loss and not just the negative probability of the data distribution: $h(v_{I},v_{I^{t}})$?
