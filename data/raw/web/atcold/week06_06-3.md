---
source_url: "https://atcold.github.io/NYU-DLSP20/en/week06/06-3"
title: "Deep Learning"
date: "2020-03-03"
extractor: "generic"
---
...
![](/NYU-DLSP20/images/week06/06-3/vanilla.png)**Figure 1:**Vanilla Architecture
...
![](/NYU-DLSP20/images/week06/06-3/rnn.png)**Figure 2:**RNN Architecture ![](/NYU-DLSP20/images/week06/06-3/basic_neural_net.png)

**Figure 3:**Basic NN Architecture
...
**Figure 4:**Yann's RNN Architecture
...
![](/NYU-DLSP20/images/week06/06-3/vec_seq.png)**Figure 5:**Vec to Seq
...
![](/NYU-DLSP20/images/week06/06-3/image_to_text_vec2seq.png)**Figure 6:**vec2seq Example: Image to Text
...
![](/NYU-DLSP20/images/week06/06-3/seq2vec.png)**Figure 7:**Seq to Vec ![](/NYU-DLSP20/images/week06/06-3/second_1.png)

**Figure 8:**Input lines of Python Codes

Then the network will be able to output the correct solution of this program. Another more complicated program like this:

![](/NYU-DLSP20/images/week06/06-3/second_2.png)**Figure 9:**Input lines of Python Codes in a more Completed Case
...
![](/NYU-DLSP20/images/week06/06-3/seq2vec2seq.png)**Figure 10:**Seq to Vec to Seq

If you do a PCA over the latent space, you will have the words grouped by semantics like shown in this graph.

![](/NYU-DLSP20/images/week06/06-3/third_1.png)**Figure 11:**Words Grouped by Semantics after PCA

If we zoom in, we will see that the in the same location there are all the months, like January and November.

![](/NYU-DLSP20/images/week06/06-3/third_2.png)**Figure 12:**Zooming in Word Groups

If you focus on a different region, you get phrases like “a few days ago “ “the next few months” etc.

![](/NYU-DLSP20/images/week06/06-3/third_3.png)**Figure 13:**Word Groups in another Region
...
![](/NYU-DLSP20/images/week06/06-3/fourth.png)**Figure 14:**Semantics Features Picked during Training
...
![](/NYU-DLSP20/images/week06/06-3/seq2seq.png)**Figure 15:**Seq to Seq ![](/NYU-DLSP20/images/week06/06-3/seq2seq_model_completion.png)

**Figure 16:**Text Auto-Completion Model of Seq to Seq Model
...
![](/NYU-DLSP20/images/week06/06-3/rnn_2.png)**Figure 21:**Skip Connection
...
![](/NYU-DLSP20/images/week06/06-3/lstm.png)**Figure 22:**LSTM Architecture
...
![](/NYU-DLSP20/images/week06/06-3/lstm_2.png)**Figure 23:**LSTM Architecture - Output On ![](/NYU-DLSP20/images/week06/06-3/lstm_3.png)

**Figure 24:**LSTM Architecture - Output Off
...
![](/NYU-DLSP20/images/week06/06-3/memory_cell_vis.png)**Figure 25:**Visualization of the Memory Cell ![](/NYU-DLSP20/images/week06/06-3/lstm_4.png)

**Figure 26:**LSTM Architecture - Reset Memory ![](/NYU-DLSP20/images/week06/06-3/lstm_keep_memory.png)

**Figure 27:**LSTM Architecture - Keep Memory ![](/NYU-DLSP20/images/week06/06-3/lstm_write_memory.png)

**Figure 28:**LSTM Architecture - Write Memory
...
**Figure 29:**Input Vector Example
...
**Figure 30:**Simple RNN *vs.* LSTM - 10 Epochs
...
![](/NYU-DLSP20/images/week06/06-3/train_test_hard.png)**Figure 31:**Simple RNN *vs.* LSTM - 100 Epochs
...
![](/NYU-DLSP20/images/week06/06-3/hidden_state_lstm.png)**Figure 32:**Visualization of Hidden State Value
