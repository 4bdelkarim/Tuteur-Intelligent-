---
source_url: "https://atcold.github.io/NYU-DLSP20/en/week10/10-3/"
title: "Deep Learning"
date: "2020-04-07"
extractor: "generic"
---
...
| ![](/NYU-DLSP20/images/week10/10-3/fig1.png) | 
...
- The back of the trailer is parallel to the wall loading dock, *e.g.*$\ttrailer = 0$.
- The back of the trailer ($\xtrailer, \ytrailer$) is as close as possible to the point ($x_{dock}, y_{dock}$) as shown above.

## More Parameters and Visualization

| ![](/NYU-DLSP20/images/week10/10-3/fig2.png) | 
...
\[\begin{aligned} \dot{\theta_0} &= \frac{s}{L}\tan(\phi)\\ \dot{\theta_1} &= \frac{s}{d_1}\sin(\theta_1 - \theta_0)\\ \dot{x} &= s\cos(\theta_0)\\ \dot{y} &= s\sin(\theta_0) \end{aligned}\]Here, $s$ denotes the signed speed and $\phi$ the negative steering angle. Now we can represent the state by only four parameters: $\xcab$, $\ycab$, $\theta_0$ and $\theta_1$. This is because Length parameters are known and $\xtrailer, \ytrailer$ is determined by $\xcab, \ycab, d_1, \theta_1$.

In the Jupyter Notebook from the Deep Learning repository, we have some sample environments shown in Figures 3.(1-4):

| ![](/NYU-DLSP20/images/week10/10-3/fig3.png) | ![](/NYU-DLSP20/images/week10/10-3/fig4.png) | 
| Fig. 3.1: Sample plot of the environment | Fig. 3.2: Driving into itself (jackknifing) | 
| ![](/NYU-DLSP20/images/week10/10-3/fig5.png) | ![](/NYU-DLSP20/images/week10/10-3/fig6.png) | 
...
| ![](/NYU-DLSP20/images/week10/10-3/fig7.png) | 
...
| ![](/NYU-DLSP20/images/week10/10-3/fig8.png) | 
...
| ![](/NYU-DLSP20/images/week10/10-3/fig13.png) | 
...
![](/NYU-DLSP20/images/week10/10-3/fig14.png)
...
| ![](/NYU-DLSP20/images/week10/10-3/fig16.png) | ![](/NYU-DLSP20/images/week10/10-3/fig17.png) | 
| ![](/NYU-DLSP20/images/week10/10-3/fig18.png) | ![](/NYU-DLSP20/images/week10/10-3/fig19.png) | 
