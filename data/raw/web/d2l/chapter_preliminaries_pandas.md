...
[library](https://pandas.pydata.org/) can do much of the heavy
...
[matplotlib](https://matplotlib.org/) can help you to manually
...
1. Try loading datasets, e.g., Abalone from the [UCI Machine Learning
   Repository](https://archive.ics.uci.edu/ml/datasets.php) and
...
5. What alternatives to pandas can you think of? How about [loading
   ...
   file](https://numpy.org/doc/stable/reference/generated/numpy.load.html)?
   Check out [Pillow](https://python-pillow.org/), the Python Imaging
   Library.
