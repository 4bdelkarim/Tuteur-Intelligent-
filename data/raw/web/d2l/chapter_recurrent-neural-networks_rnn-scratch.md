...
![../_images/output_rnn-scratch_546c4d_155_0.svg](../_images/output_rnn-scratch_546c4d_155_0.svg)
...
8. Modify the prediction method so as to use sampling rather than
   ...
   - Bias the model towards more likely outputs, e.g., by sampling
     from
     $q(x_t \mid x_{t-1}, \ldots, x_1) \propto P(x_t \mid x_{t-1}, \ldots, x_1)^\alpha$
     for $\alpha > 1$.
