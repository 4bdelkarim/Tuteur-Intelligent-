...
CUDA](https://developer.nvidia.com/cuda-downloads) and follow the
...
![../_images/copyto.svg](../_images/copyto.svg)
...
3. Measure the time it takes to compute 1000 matrix–matrix
   multiplications of $100 \times 100$ matrices and log the
