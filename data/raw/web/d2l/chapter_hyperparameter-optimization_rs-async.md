...
![../_images/distributed_scheduling.svg](../_images/distributed_scheduling.svg)
...
![../_images/output_rs-async_d37aa6_19_1.svg](../_images/output_rs-async_d37aa6_19_1.svg)
...
![../_images/output_rs-async_d37aa6_21_1.svg](../_images/output_rs-async_d37aa6_21_1.svg)
...
1. Consider the `DropoutMLP` model implemented in
   Section 5.6, and used in Exercise 1 of
   Section 19.2.
   ...
   1. Implement an objective function
      ...
      every epoch.
   2. Using the setup of Exercise 1 in Section 19.2, compare
...
2. *Advanced*. The goal of this exercise is to implement a new scheduler
   ...
   1. Create a virtual environment containing both the
      [d2lbook](https://github.com/d2l-ai/d2l-en/blob/master/INFO.md#installation-for-developers)
      and
      [syne-tune](https://syne-tune.readthedocs.io/en/latest/getting_started.html)
      sources.
   2. Implement the `LocalSearcher` from Exercise 2 in
      Section 19.2 as a new searcher in Syne Tune. Hint: Read
      [this
      tutorial](https://syne-tune.readthedocs.io/en/latest/tutorials/developer/README.html).
      Alternatively, you may follow this
      [example](https://syne-tune.readthedocs.io/en/latest/examples.html#launch-hpo-experiment-with-home-made-scheduler).
