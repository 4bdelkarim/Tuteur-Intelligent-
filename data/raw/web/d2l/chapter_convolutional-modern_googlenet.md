...
![../_images/inception.svg](../_images/inception.svg)
...
![../_images/inception-full-90.svg](../_images/inception-full-90.svg)
...
![../_images/output_googlenet_83a8b4_135_0.svg](../_images/output_googlenet_83a8b4_135_0.svg)
...
1. GoogLeNet was so successful that it went through a number of
   ...
   1. Add a batch normalization layer (Ioffe and Szegedy, 2015), as
      described later in Section 8.5.
   ...
   4. Make further adjustments to the Inception block by adding residual
      connection (Szegedy et al., 2017), as described
...
3. Can you design a variant of GoogLeNet that works on Fashion-MNIST’s
   native resolution of $28 \times 28$ pixels? How would you need
