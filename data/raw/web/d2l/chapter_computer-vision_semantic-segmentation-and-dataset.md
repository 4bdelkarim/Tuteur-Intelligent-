---
source_url: "https://d2l.ai/chapter_computer-vision/semantic-segmentation-and-dataset.html"
title: "14.9. Semantic Segmentation and the Dataset"
chapter: "14"
section_number: "14.9"
date: null
extractor: "d2l"
...
Section 14.3–Section 14.8, rectangular bounding boxes
...
Fig. 14.9.1 shows the labels of the dog, cat, and
...
![../_images/segmentation.svg](../_images/segmentation.svg)

Fig. 14.9.1 Labels of the dog, cat, and background of the image in semantic
segmentation.
...
- *Image segmentation* divides an image into several constituent
  ...
  Fig. 14.9.1 as input, image segmentation may divide
...
VOC2012](http://host.robots.ox.ac.uk/pascal/VOC/voc2012/). In the
...
![../_images/output_semantic-segmentation-and-dataset_23ff18_30_0.png](../_images/output_semantic-segmentation-and-dataset_23ff18_30_0.png)
...
Section 8.1–Section 8.4, images are rescaled
...
![../_images/output_semantic-segmentation-and-dataset_23ff18_66_0.png](../_images/output_semantic-segmentation-and-dataset_23ff18_66_0.png)
...
the output shape of randomly cropped images is $320\times 480$.
...
2. Recall the descriptions of data augmentation in
   Section 14.1. Which of the image augmentation
