---
source_url: "https://d2l.ai/chapter_attention-mechanisms-and-transformers/bahdanau-attention.html"
title: "11.4. The Bahdanau Attention Mechanism"
chapter: "11"
section_number: "11.4"
date: null
extractor: "d2l"
...
When we encountered machine translation in Section 10.7, we
designed an encoder–decoder architecture for sequence-to-sequence
learning based on two RNNs (Sutskever et al., 2014).
...
Recall Fig. 10.7.2 which we repeat
(Fig. 11.4.1) with some additional detail.
...
![../_images/seq2seq-state.svg](../_images/seq2seq-state.svg)

Fig. 11.4.1 Sequence-to-sequence model. The state, as generated by the encoder,
...
was Graves (2013) who tried to design an RNN to generate
...
Bahdanau *et al.* (2014) proposed a differentiable attention
...
(Vaswani et al., 2017) and many related new
architectures.
...
architecture of Section 10.7, in particular
(10.7.3). The key idea is that instead of keeping the
...
(10.7.3). In particular, the attention weight
$\alpha$ is computed as in (11.3.3) using
the additive attention scoring function defined by
(11.3.7). This RNN encoder–decoder architecture using
attention is depicted in Fig. 11.4.2. Note
...
$t'-1$). For instance, see Chan *et al.* (2015) for a
description of this strategy, as applied to speech recognition.

![../_images/seq2seq-details-attention.svg](../_images/seq2seq-details-attention.svg)

Fig. 11.4.2 Layers in an RNN encoder–decoder model with the Bahdanau attention
mechanism.
...
Section 10.7.6: specify the hyperparameters,
...
![../_images/output_bahdanau-attention_dd4710_60_0.svg](../_images/output_bahdanau-attention_dd4710_60_0.svg)
...
![../_images/output_bahdanau-attention_dd4710_90_0.svg](../_images/output_bahdanau-attention_dd4710_90_0.svg)
