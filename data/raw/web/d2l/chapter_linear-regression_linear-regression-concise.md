...
![../_images/output_linear-regression-concise_bee6dc_87_0.svg](../_images/output_linear-regression-concise_bee6dc_87_0.svg)
...
5. How does the solution change as you vary the amount of data
   ...
   1. Plot the estimation error for
      $\hat{\mathbf{w}} - \mathbf{w}$ and $\hat{b} - b$ as a
