---
source_url: "https://d2l.ai/chapter_computer-vision/neural-style.html"
title: "14.12. Neural Style Transfer"
chapter: "14"
...
*style transfer* (Gatys et al., 2016). This task needs two
...
Fig. 14.12.1 is a landscape photo taken by us in Mount
...
![../_images/style-transfer.svg](../_images/style-transfer.svg)

Fig. 14.12.1 Given content and style images, style transfer outputs a synthesized
image.

## 14.12.1. Method

Fig. 14.12.2 illustrates the CNN-based style
...
Take Fig. 14.12.2 as an example. The pretrained
...
![../_images/neural-style.svg](../_images/neural-style.svg)

Fig. 14.12.2 CNN-based style transfer process. Solid lines show the direction of
...
![../_images/output_neural-style_5de8ca_3_0.svg](../_images/output_neural-style_5de8ca_3_0.svg)
...
![../_images/output_neural-style_5de8ca_4_0.svg](../_images/output_neural-style_5de8ca_4_0.svg)
...
image features (Gatys et al., 2016).
...
are also called *style layers*. As mentioned in Section 8.2, the
...
$x_{i, j}$ the pixel value at coordinate $(i, j)$. Reducing
total variation loss

$$
(14.12.1)\[\sum_{i, j} \left|x_{i, j} - x_{i+1, j}\right| + \left|x_{i, j} - x_{i, j+1}\right|
$$
...
![../_images/output_neural-style_5de8ca_140_0.svg](../_images/output_neural-style_5de8ca_140_0.svg)
