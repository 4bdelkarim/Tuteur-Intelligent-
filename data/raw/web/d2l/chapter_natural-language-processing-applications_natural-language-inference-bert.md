---
source_url: "https://d2l.ai/chapter_natural-language-processing-applications/natural-language-inference-bert.html"
title: "16.7. Natural Language Inference: Fine-Tuning BERT"
chapter: "16"
section_number: "16.7"
date: null
extractor: "d2l"
...
Section 16.6, natural language inference is a
...
![../_images/nlp-map-nli-bert.svg](../_images/nlp-map-nli-bert.svg)

Fig. 16.7.1 This section feeds pretrained BERT to an MLP-based architecture for
...
Section 15.9 and Section 15.10 (note
that the original BERT model is pretrained on much bigger corpora). As
discussed in Section 15.10, the original BERT model
...
Fig. 16.6.2. Recall Section 15.8.4
...
As Fig. 16.6.2 indicates, fine-tuning BERT for natural
...
Recall that in Section 15.8 both the `MaskLM` class and the
...
![../_images/output_natural-language-inference-bert_1857e6_75_1.svg](../_images/output_natural-language-inference-bert_1857e6_75_1.svg)
