---
source_url: "https://d2l.ai/chapter_recommender-systems/deepfm.html"
title: "21.10. Deep Factorization Machines"
chapter: "21"
...
factorization machines (DeepFM) (Guo et al., 2017) which
...
output as $\hat{y}^{(FM)}$. Readers are referred to the last
section for more details. Let $\mathbf{e}_i \in \mathbb{R}^{k}$
denote the latent feature vector of the $i^\textrm{th}$ field. The
...
where $f$ is the number of fields. It is then fed into the
...
where $\alpha$ is the activation function. $\mathbf{W}_{l}$
and $\mathbf{b}_{l}$ are the weight and bias at the
$l^\textrm{th}$ layer. Let $y_{DNN}$ denote the output of
...
where $\sigma$ is the sigmoid function. The architecture of DeepFM
is illustrated below. ![Illustration of the DeepFM model](../_images/rec-deepfm.svg)
...
feature interactions (He and Chua, 2017).
...
![../_images/output_deepfm_61b173_5_1.svg](../_images/output_deepfm_61b173_5_1.svg)
