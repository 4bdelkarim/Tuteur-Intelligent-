---
source_url: "https://d2l.ai/chapter_computer-vision/object-detection-dataset.html"
title: "14.6. The Object Detection Dataset"
chapter: "14"
section_number: "14.6"
date: null
extractor: "d2l"
...
(batch size, $m$, 5), where $m$ is the largest possible
...
number of bounding boxes; thus, images with fewer than $m$
bounding boxes will be padded with illegal bounding boxes until
$m$ is reached. Then the label of each bounding box is represented
...
($x$, $y$)-coordinate values of the upper-left corner and
...
![../_images/output_object-detection-dataset_641ef0_48_0.png](../_images/output_object-detection-dataset_641ef0_48_0.png)
