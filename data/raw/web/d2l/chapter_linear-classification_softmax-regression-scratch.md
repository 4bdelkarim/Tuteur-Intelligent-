...
physics](https://en.wikipedia.org/wiki/Partition_function_(statistical_mechanics))
...
![../_images/output_softmax-regression-scratch_aecde8_120_0.svg](../_images/output_softmax-regression-scratch_aecde8_120_0.svg)
...
![../_images/output_softmax-regression-scratch_aecde8_150_0.svg](../_images/output_softmax-regression-scratch_aecde8_150_0.svg)
...
1. In this section, we directly implemented the softmax function based
   ...
   in Section 4.1 this can cause numerical instabilities.
   ...
   2. Test whether `softmax` still works correctly if the largest of
      all inputs is smaller than $-100$?
...
2. Implement a `cross_entropy` function that follows the definition of
   the cross-entropy loss function $\sum_i y_i \log \hat{y}_i$.
