---
source_url: "https://d2l.ai/chapter_computer-vision/image-augmentation.html"
title: "14.1. Image Augmentation"
chapter: "14"
section_number: "14.1"
date: null
extractor: "d2l"
...
In Section 8.1, we mentioned that large datasets are a
...
the following $400\times 500$ image an example.
...
![../_images/output_image-augmentation_7d0887_12_0.svg](../_images/output_image-augmentation_7d0887_12_0.svg)
...
![../_images/output_image-augmentation_7d0887_31_0.svg](../_images/output_image-augmentation_7d0887_31_0.svg)
...
![../_images/output_image-augmentation_7d0887_33_0.svg](../_images/output_image-augmentation_7d0887_33_0.svg)

In the example image we used, the cat is in the middle of the image, but
this may not be the case in general. In Section 7.5, we
...
$10\% \sim 100\%$ of the original area each time, and the ratio of
width to height of this area is randomly selected from
$0.5 \sim 2$. Then, the width and height of the region are both
scaled to 200 pixels. Unless otherwise specified, the random number
between $a$ and $b$ in this section refers to a continuous
...
![../_images/output_image-augmentation_7d0887_45_0.svg](../_images/output_image-augmentation_7d0887_45_0.svg)
...
a value between 50% ($1-0.5$) and 150% ($1+0.5$) of the
original image.
...
![../_images/output_image-augmentation_7d0887_54_0.svg](../_images/output_image-augmentation_7d0887_54_0.svg)
...
![../_images/output_image-augmentation_7d0887_63_0.svg](../_images/output_image-augmentation_7d0887_63_0.svg)
...
![../_images/output_image-augmentation_7d0887_72_0.svg](../_images/output_image-augmentation_7d0887_72_0.svg)
...
![../_images/output_image-augmentation_7d0887_81_0.svg](../_images/output_image-augmentation_7d0887_81_0.svg)
...
![../_images/output_image-augmentation_7d0887_90_1.svg](../_images/output_image-augmentation_7d0887_90_1.svg)
...
We train the ResNet-18 model from Section 8.6 on the CIFAR-10
dataset. Recall the introduction to multi-GPU training in
Section 13.6. In the following, we define a
...
![../_images/output_image-augmentation_7d0887_130_1.svg](../_images/output_image-augmentation_7d0887_130_1.svg)
