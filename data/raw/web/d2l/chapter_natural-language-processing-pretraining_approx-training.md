...
![../_images/hi-softmax.svg](../_images/hi-softmax.svg)
...
3. How to train the continuous bag of words model using negative
   sampling and hierarchical softmax, respectively?
